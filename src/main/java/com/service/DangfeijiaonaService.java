...
public interface DangfeijiaonaService extends IService<DangfeijiaonaEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<DangfeijiaonaEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<DangfeijiaonaEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<DangfeijiaonaEntity> wrapper);
}
