...
public class DangyuanzhuanruEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DangyuanzhuanruEntity() {
		
	}
	
	public DangyuanzhuanruEntity(T t) {
		try {
	...
	private String zhuanrushenqing;
	 ...
	 * 设置：转入申请
	 */
	public void setZhuanrushenqing(String zhuanrushenqing) {
		this.zhuanrushenqing = zhuanrushenqing;
	}
	/**
	 * 获取：转入申请
	 */
	public String getZhuanrushenqing() {
		return zhuanrushenqing;
	}
	/**
	 * 设置：申请时间
	 */
