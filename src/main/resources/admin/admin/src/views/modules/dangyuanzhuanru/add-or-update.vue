    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="转入申请" prop="zhuanrushenqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhuanrushenqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanrushenqing" label="转入申请" prop="zhuanrushenqing">
                    <span v-html="ruleForm.zhuanrushenqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='zhuanrushenqing'){
            this.ruleForm.zhuanrushenqing = obj[o];
	    this.ro.zhuanrushenqing = true;
            continue;
          }
	...
	this.ruleForm.zhuanrushenqing = this.ruleForm.zhuanrushenqing.replace(reg,'../../../springboothb963/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangyuanzhuanru/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangyuanzhuanruCrossAddOrUpdateFlag = false;
						 this.parent.search();
