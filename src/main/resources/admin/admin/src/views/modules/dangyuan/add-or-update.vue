<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="党支部" prop="dangzhibu">
          <el-select :disabled="ro.dangzhibu" v-model="ruleForm.dangzhibu" placeholder="请选择党支部">
            <el-option
                v-for="(item,index) in dangzhibuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="党支部" prop="dangzhibu">
	      <el-input v-model="ruleForm.dangzhibu"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.rudangshijian = true;
          ...
          if(o=='dangzhibu'){
            this.ruleForm.dangzhibu = obj[o];
	    this.ro.dangzhibu = true;
            continue;
          }
          if(o=='zhuzhi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zhengzhimianmaoOptions = "预备党员,正式党员".split(',')
            this.$http({
              url: `option/dangzhibu/dangzhibu`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.dangzhibuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
