<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党支部" prop="dangzhibu">
          <el-input v-model="ruleForm.dangzhibu" 
              placeholder="党支部" clearable  :readonly="ro.dangzhibu"></el-input>
        </el-form-item>
        <div v-else>
    ...
    dangyuanzhanghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.dangzhibu){
                this.ruleForm.dangzhibu = data.data.dangzhibu
              }
