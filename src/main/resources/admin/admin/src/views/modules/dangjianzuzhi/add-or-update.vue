<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="组织账号" prop="zuzhizhanghao">
          <el-input v-model="ruleForm.zuzhizhanghao" 
              placeholder="组织账号" clearable  :readonly="ro.zuzhizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="组织账号" prop="zuzhizhanghao">
              <el-input v-model="ruleForm.zuzhizhanghao" 
                placeholder="组织账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="创立者" prop="chuanglizhe">
          <el-input v-model="ruleForm.chuanglizhe" 
              placeholder="创立者" clearable  :readonly="ro.chuanglizhe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="创立者" prop="chuanglizhe">
              <el-input v-model="ruleForm.chuanglizhe" 
                placeholder="创立者" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="组织人数" prop="zuzhirenshu">
          <el-input v-model="ruleForm.zuzhirenshu" 
              placeholder="组织人数" clearable  :readonly="ro.zuzhirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="组织人数" prop="zuzhirenshu">
              <el-input v-model="ruleForm.zuzhirenshu" 
                placeholder="组织人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="组织详情" prop="zuzhixiangqing">
          <el-input v-model="ruleForm.zuzhixiangqing" 
              placeholder="组织详情" clearable  :readonly="ro.zuzhixiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="组织详情" prop="zuzhixiangqing">
              <el-input v-model="ruleForm.zuzhixiangqing" 
                placeholder="组织详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="管理党支部" prop="guanlidangzhibu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="管理党支部"
                  v-model="ruleForm.guanlidangzhibu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guanlidangzhibu" label="管理党支部" prop="guanlidangzhibu">
                    <span>{{ruleForm.guanlidangzhibu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="管理成员" prop="guanlichengyuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="管理成员"
                  v-model="ruleForm.guanlichengyuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guanlichengyuan" label="管理成员" prop="guanlichengyuan">
                    <span>{{ruleForm.guanlichengyuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	chuangliriqi : false,
	guanlidangzhibu : false,
	guanlichengyuan : false,
      },
      ruleForm: {
        zuzhizhanghao: '',
        mima: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuzhimingcheng = true;
          ...
          if(o=='chuanglizhe'){
            this.ruleForm.chuanglizhe = obj[o];
	    this.ro.chuanglizhe = true;
            continue;
          }
          if(o=='zuzhirenshu'){
            this.ruleForm.zuzhirenshu = obj[o];
	    this.ro.zuzhirenshu = true;
            continue;
          }
          if(o=='lianxidianhua'){
	    ...
	    this.ro.chuangliriqi = true;
          ...
          if(o=='guanlidangzhibu'){
            this.ruleForm.guanlidangzhibu = obj[o];
	    this.ro.guanlidangzhibu = true;
            continue;
          }
          if(o=='guanlichengyuan'){
            this.ruleForm.guanlichengyuan = obj[o];
	    this.ro.guanlichengyuan = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangjianzuzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangjianzuzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
