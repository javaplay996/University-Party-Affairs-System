<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴费人数" prop="jiaofeirenshu">
          <el-input v-model="ruleForm.jiaofeirenshu" 
              placeholder="缴费人数" clearable  :readonly="ro.jiaofeirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴费人数" prop="jiaofeirenshu">
              <el-input v-model="ruleForm.jiaofeirenshu" 
                placeholder="缴费人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="未交费人数" prop="weijiaofeirenshu">
          <el-input v-model="ruleForm.weijiaofeirenshu" 
              placeholder="未交费人数" clearable  :readonly="ro.weijiaofeirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="未交费人数" prop="weijiaofeirenshu">
              <el-input v-model="ruleForm.weijiaofeirenshu" 
                placeholder="未交费人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuefen = true;
          ...
          if(o=='jiaofeirenshu'){
            this.ruleForm.jiaofeirenshu = obj[o];
	    this.ro.jiaofeirenshu = true;
            continue;
          }
          if(o=='weijiaofeirenshu'){
            this.ruleForm.weijiaofeirenshu = obj[o];
	    this.ro.weijiaofeirenshu = true;
            continue;
          }
          if(o=='tongjishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaofeitongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaofeitongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
