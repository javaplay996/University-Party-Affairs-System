    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="转出申请" prop="zhuanchushenqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhuanchushenqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanchushenqing" label="转出申请" prop="zhuanchushenqing">
                    <span v-html="ruleForm.zhuanchushenqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='zhuanchushenqing'){
            this.ruleForm.zhuanchushenqing = obj[o];
	    this.ro.zhuanchushenqing = true;
            continue;
          }
	...
	this.ruleForm.zhuanchushenqing = this.ruleForm.zhuanchushenqing.replace(reg,'../../../springboothb963/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangyuanzhuanchu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangyuanzhuanchuCrossAddOrUpdateFlag = false;
						 this.parent.search();
